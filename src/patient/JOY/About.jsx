...
export default function AboutFigma() {
  ...
  return (
    <main>
      ...
      {/* Scale wrapper so the 1440px canvas doesn’t overflow on smaller desktops */}
      <div className="about-wrap">
        <div className="about-canvas">
          ...
          {/* --- HEADING GROUP (title + intro) --- */}
          <div className="about-hgroup">
            <h1 className="about-title">Your Health, Your Control</h1>
          ...
          <div className="about-card about-card--mission">
            ...
            <p className="about-card-text">
              To provide patients with easy, secure access to their health records,
              foster transparent communication with healthcare professionals, and
              support proactive health decisions through technology.
            </p>
          </div>
          ...
          <div className="about-card about-card--vision">
            ...
            <p className="about-card-text">
              To be the leading digital health companion, empowering individuals to
              take charge of their well-being through personalized, connected, and
          ...
          {/* --- OFFER CARDS --- */}
          <div className="about-offer about-offer--left" />
          <div className="about-offer about-offer--right" />

          {/* Left offer title + divider + text */}
          <h4 className="about-offer-heading about-offer-heading--left">
            What We Offer
          </h4>
          <div className="about-offer-line about-offer-line--left" />
          <p className="about-offer-text about-offer-text--left">
            Easy access to personal medical records anytime, anywhere. <br />
            Streamlined communication with healthcare providers. <br />
            Personalized health tracking and reminders.
          </p>

          {/* Right offer title + divider + text */}
          <h4 className="about-offer-heading about-offer-heading--right">
            What We Offer
          </h4>
          <div className="about-offer-line about-offer-line--right" />
          <p className="about-offer-text about-offer-text--right">
            Secure data handling and privacy-first approach. <br />
            Seamless appointment scheduling. <br />
            Tools for medication management and wellness insights.
          </p>
